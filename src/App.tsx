...
function App() {
  ...
  return (
    <>
      {/* --- DESKTOP VIEW --- */}
      <div className="hidden md:flex min-h-screen flex-col text-slate-100 font-sans">
        <Background3D />
        <Header />
      ...
      {/* --- MOBILE VIEW --- */}
      <div className="flex md:hidden min-h-screen flex-col bg-slate-900 text-slate-100 font-sans">
